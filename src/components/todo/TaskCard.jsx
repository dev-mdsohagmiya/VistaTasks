  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        whileHover="hover"
        whileTap="tap"
        className="bg-white dark:bg-gray-900 rounded-[10px] border border-gray-200 dark:border-gray-800 p-3 sm:p-4 md:p-6 shadow-[0_4px_8px_rgba(0,0,0,0.25)] cursor-pointer"
      >
        {/* Mobile Layout */}
            ...
            <div className="flex gap-2 w-full">
              <div>
                <motion.button
                  ...
                  variants={checkboxVariants}
                  animate={todo.isCompleted ? "checked" : "unchecked"}
                  className={`mt-1 w-5 h-5 sm:w-5 sm:h-5 rounded border-2 flex items-center justify-center transition-colors ${
                    todo.isCompleted
                      ? "bg-green-500 border-green-500"
                      : "border-gray-300 hover:border-green-500"
                  }`}
