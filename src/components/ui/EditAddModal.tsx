...
export const EditAddModal = ({ setShowAddModal }: any) => {
    return <>
        ...
        >
            ...
            >
                ...
                <div className="flex gap-3 mt-6">
                    ...
                    <button className="flex-1 py-3 px-4 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
                        Add Task
                    </button>
                </div>
            </div>
